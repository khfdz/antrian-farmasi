...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-[#3B82F6] to-[#1D4ED8] shadow-4xl relative overflow-hidden">
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-4">
            <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-2 shadow-lg border border-white/30">
              <img
                src="/logo.png"
                alt="Logo"
                className="w-14 bg-white p-2 rounded-lg"
              />
            </div>
          ...
          <div className="text-center">
            <div className="bg-white/15 backdrop-blur-md rounded-2xl py-1 shadow-xl border border-white/20 mb-2 transform hover:scale-105 transition-all duration-300">
              <div className="text-md font-black text-white drop-shadow-md">
                {formatTime(currentTime)}
              </div>
            </div>

            <div className="bg-white/10 backdrop-blur-sm rounded-xl px-4 py-1 shadow-lg border border-white/20">
              <div className="text-md font-bold text-white capitalize drop-shadow-md">
      ...
      <div
        className="absolute top-8 left-1/3 w-1 h-1 bg-white/40 rounded-full animate-ping"
